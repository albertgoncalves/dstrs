...
static const u32 OBSERVED_PAIRS = (OBSERVED_PICKED - OBSERVED_SINGLES) / 2;
...
i32 main(i32 n, const char** args) {
    ...
    }
    {
        ...
        for (usize i = 0; i < SIZE_RESULTS; ++i) {
            ...
            {
                const i32 line = sprintf(&memory->buffer[size],
                                         "%u\n",
